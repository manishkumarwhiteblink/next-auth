...
export default function TraditionalBackofficeDashboard() {
    ...
    return (
        <AuthGuard requiredRole="ROLE_TRADITIONALBACKOFFICE"  fallback={<div>Access Denied</div>}>
                        ...
                        <div className="flex justify-between items-center py-4">
                            <div className="flex items-center space-x-4">
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                        <h1 className="text-2xl font-bold text-gray-900">Traditional Backoffice Dashboard</h1>
